<x-app-layout>
    ...
    <div class="flex flex-col gap-6">
        <div class="p-6 bg-primary-light border border-warm-border-soft rounded-2xl flex items-center justify-between max-w-xl">
            <div>
            ...
            <p class="font-serif text-2xl font-bold text-primary-dark">{{ auth()->user()->humanityBadgePoints() }} pts</p>
        </div>
